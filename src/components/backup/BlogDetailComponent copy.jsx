        ...
        <div className="row">
          ...
          <div className="col-md-9">
            <img
              ...
              alt=""
            />
            <h1 className="tw-pt-10 fw-bold tw-text-5xl">
              Build a stronger brand <br />
              with no-code tools
            </h1>
            <p>
            ...
            <h2 className="fw-bold">Why do we use it?</h2>
            <p>
            ...
            <h2 className="fw-bold">Where can I get some?</h2>
            <p>
...
export default BlogDetailComponentCopy;
